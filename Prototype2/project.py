...
def pathfinding(input_filename, a_data_filename, b_data_filename, c_data_filename, final_state_filename):
          ...
          for x in b_neighbours:  #for every neighbour x
            ...
            if not(in_frontier) and not(in_explored) and not(x.dataval[0] == 'X'):  #if the neighbour is not in the frontier, not explored, and not an X value (wall)
              ...
              if (x.dataval[0] == 'A' or x.dataval[0] == 'C'):  #if x is a goal node
                ...
                x.b_priority = 0  #and its priority is also 0 meaning it is equal to the path cost
              else:  #otherwise it is a number
                x.b_path_cost = b_leaf.b_path_cost + int(x.dataval[0])  #the path cost is the previous path cost + the traversal cost
                x.b_priority = x.dataval[4]  #the priority is the total path cost + the priority
        ...
        if c_leaf.dataval[0] == 'A' or c_leaf.dataval[0] == 'B':  #if it is a goal node
          ...
          for x in c_neighbours:  #for every neighbour x
            ...
            if not(in_frontier) and not(in_explored) and not(x.dataval[0] == 'X'):  #if the neighbour is not in the frontier, not explored, and not an X value (wall)
              ...
              if (x.dataval[0] == 'A' or x.dataval[0] == 'B'):  #if x is a goal node
                x.c_path_cost = c_leaf.c_path_cost  #then its traversal cost is 0 so its path cost is the same as the previous path
                x.c_priority = x.c_path_cost  #and its priority is also 0 meaning it is equal to the path cost
              else:  #otherwise it is a number
                x.c_path_cost = c_leaf.c_path_cost + int(x.dataval[0])  #the path cost is the previous path cost + the traversal cost
                x.c_priority = x.c_path_cost  #the priority is the total path cost + the priority
  ...
  f.write("\nScore (Path Cost + 1/5 explored list length):\n")
  if (a_goal):
    f.write(str(a_optimal_path_cost + 0.2 * len(a_explored)))
  f.close()
  ...
  f.write("\nScore (Path Cost + 1/5 explored list length):\n")
  if (b_goal):
    f.write(str(b_optimal_path_cost + 0.2 * len(b_explored)))
  f.close()
  ...
  f.write("\nScore (Path Cost + 1/5 explored list length):\n")
  if (c_goal):
    f.write(str(c_optimal_path_cost + 0.2 * len(c_explored)))
  f.close()
...
pathfinding("Test1/input.txt", "Test1/a_Data.txt", "Test1/b_Data.txt", "Test1/c_Data.txt", "Test1/output.txt")
pathfinding("Test1_Alt1/input.txt", "Test1_Alt1/a_Data.txt", "Test1_Alt1/b_Data.txt", "Test1_Alt1/c_Data.txt", "Test1_Alt1/output.txt")
pathfinding("Test1_Alt2/input.txt", "Test1_Alt2/a_Data.txt", "Test1_Alt2/b_Data.txt", "Test1_Alt2/c_Data.txt", "Test1_Alt2/output.txt")

pathfinding("Test2/input.txt", "Test2/a_Data.txt", "Test2/b_Data.txt", "Test2/c_Data.txt", "Test2/output.txt")
pathfinding("Test2_Alt1/input.txt", "Test2_Alt1/a_Data.txt", "Test2_Alt1/b_Data.txt", "Test2_Alt1/c_Data.txt", "Test2_Alt1/output.txt")
pathfinding("Test2_Alt2/input.txt", "Test2_Alt2/a_Data.txt", "Test2_Alt2/b_Data.txt", "Test2_Alt2/c_Data.txt", "Test2_Alt2/output.txt")

pathfinding("Test3/input.txt", "Test3/a_Data.txt", "Test3/b_Data.txt", "Test3/c_Data.txt", "Test3/output.txt")
pathfinding("Test3_Alt1/input.txt", "Test3_Alt1/a_Data.txt", "Test3_Alt1/b_Data.txt", "Test3_Alt1/c_Data.txt", "Test3_Alt1/output.txt")
pathfinding("Test3_Alt2/input.txt", "Test3_Alt2/a_Data.txt", "Test3_Alt2/b_Data.txt", "Test3_Alt2/c_Data.txt", "Test3_Alt2/output.txt")

pathfinding("Test4/input.txt", "Test4/a_Data.txt", "Test4/b_Data.txt", "Test4/c_Data.txt", "Test4/output.txt")
pathfinding("Test4_Alt1/input.txt", "Test4_Alt1/a_Data.txt", "Test4_Alt1/b_Data.txt", "Test4_Alt1/c_Data.txt", "Test4_Alt1/output.txt")
pathfinding("Test4_Alt2/input.txt", "Test4_Alt2/a_Data.txt", "Test4_Alt2/b_Data.txt", "Test4_Alt2/c_Data.txt", "Test4_Alt2/output.txt")
